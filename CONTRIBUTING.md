...
`easycontrollib` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/easycontrollib
[issue tracker]: https://github.com/<USERNAME>/easycontrollib/issues
